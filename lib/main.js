...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const forEachEmulator = (handler) => __awaiter(this, void 0, void 0, function* () {
                yield Promise.all(Array.from({ length: emulators }).map((_, i) => __awaiter(this, void 0, void 0, function* () {
                    // Ports have to be even.
                    yield handler(port + i * 2, i);
                })));
            });
            yield forEachEmulator((port, index) => __awaiter(this, void 0, void 0, function* () {
                usedPorts.push(port);
                // launch an emulator
                yield (0, emulator_manager_1.launchEmulator)(apiLevel, target, arch, profile, cores, ramSize, heapSize, sdcardPathOrSize, diskSize, index > 0 ? `${avdName}-${index + 1}` : avdName, forceAvdCreation, emulatorBootTimeout, port, emulatorOptions, disableAnimations, disableSpellchecker, disableLinuxHardwareAcceleration, enableHardwareKeyboard);
            }));
            ...
            yield forEachEmulator((port) => __awaiter(this, void 0, void 0, function* () {
                yield (0, emulator_manager_1.killEmulator)(port);
            }));
        }
        catch (error) {
            // kill the emulators so the action can exit
            yield Promise.all(usedPorts.map((port) => __awaiter(this, void 0, void 0, function* () {
                yield (0, emulator_manager_1.killEmulator)(port);
            })));
            core.setFailed(error instanceof Error ? error.message : error);
        }
